...
| **Enterprise / Markets**        | $V(N) = V_0 \times R^N
$                         | Base unit (P&L, contract)          | Recursive compounding                                                  | Resonance of value signals across scale          | Household ledger → Firm P&L → Municipal budget → National accounts → Global finance      |                                                            |
